...
import com.example.examenmoviles.viewmodel.ShowItemListActivityViewModel;
...
public class ShowItemsListActivity extends AppCompatActivity implements ItemsListAdapter.HandleItemsClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String categoryName = getIntent().getStringExtra("word_name");
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(itemName)) {
                    Toast.makeText(ShowItemsListActivity.this, "Introduzca el item", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        initRecyclerView();
        initViewModel();
        viewModel.getAllItemsList(word_id);
    }
        ...
        viewModel.getItemsListObserver().observe(this, new Observer<List<Items>>() {
            ...
            public void onChanged(List<Items> items) {
                if(items == null) {
                    ...
                    itemsListAdapter.setWordList(items);
